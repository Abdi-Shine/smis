        ...
        <div class="card-body">
            ...
            <!-- end row -->
              ...
              <div class="row mb-3">
                ...
                <div class="col-sm-10">
                    <input class="form-control" type="text" name="position" id="position" value="{{ $employee->position }}">
                </div>
            </div>
            <!-- end row -->
            ...
            <div class="row mb-3">
                ...
                <div class="col-sm-10">
                    <input class="form-control" type="date" name="start_date" id="start_date" value="{{ $employee->start_date }}">
                </div>
            </div>
            <!-- end row -->
            ...
            <div class="row mb-3">
                ...
                <div class="col-sm-10">
                    <input class="form-control" type="date" name="end_date" id="end_date" value="{{ $employee->end_date }}">
                </div>
            </div>
            <!-- end row -->
           ...
           <input name="image" class="form-control" type="file" id="image">
            ...
            <!-- end row -->
              ...
              <div class="row mb-3">
                ...
                <div class="col-sm-10">
                    <img id="showImage" class="rounded avatar-lg" src="{{ (!empty($employee->image)) ? url($employee->image) : url('upload/no_image.jpg') }}" alt="Card image cap">
                </div>
            </div>
            <!-- end row -->
